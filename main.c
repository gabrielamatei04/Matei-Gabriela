    ...
    {    if(strcmp(baza_date[i].CNP, CNP_)==0)
        {   gasit = 1;
            ...
            case Varsta:
                ...
                if(baza_date[i].varsta < 18) {printf("Persoanele cu varsta de sub 18 ani nu pot dona sange. Va multumim pentru intelegere! ");
                       printf("\n");
...
void selecteaza_donator(int n, struct fisa *baza_date){
    ...
    else {printf("CNP-ul adaugat este gresit. Nu a fost gasit niciun donator cu acest CNP in baza noastra de date. Va rugam reincercati.");
        printf("\n");
        goto selectare;
}
}
